...
class AirportListViewController: UITableViewController{
    ...
    override func tableView(_ tableView: UITableView,
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "Airportscell") as! AirportsTableViewCell
        cell.AirportShortName.text = groupairport[indexPath.section][indexPath.row]["ShortName"]
        cell.AirportIATA.text = groupairport[indexPath.section][indexPath.row]["IATA"]
        cell.AirportCity.text = groupairport[indexPath.section][indexPath.row]["ServedCity"]
        return cell
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let AirportViewController = segue.destination as! AirportViewController
        let senderIndexPath = self.tableView.indexPath(for: sender as! AirportsTableViewCell)!
